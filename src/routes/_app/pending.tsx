    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="mt-2 max-w-3xl text-[#705c67]">
          Manage your digital identity. Create, edit, or remove signature
          specimens and initials used across your legally binding documents.
        </p>
      </section>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.45fr_1fr]">
        <div className="space-y-4">
            ...
            <CardHeader className="space-y-2 px-5 pt-5 pb-2">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex rounded-md bg-[#f3e1e8] p-1">
                  <Button
                    size="sm"
                    className="h-7 rounded-md bg-white px-3 text-[0.74rem] text-primary"
                  >
                    Draw
                  </Button>
                  <Button
                    size="sm"
                    variant="ghost"
                    className="h-7 rounded-md px-3 text-[0.74rem]"
                  >
                    Type
                  </Button>
                </div>
              </div>
              <p className="text-[#7b6771] text-[0.84rem]">
                Choose your preferred method of digital signing.
              </p>
            </CardHeader>
            <CardContent className="px-5 pb-5">
              <div className="grid min-h-55 place-content-center rounded-xl border border-[#ebcad5] border-dashed bg-white text-center text-[#9a7f8b]">
                <PenIcon className="mx-auto size-7 text-[#dab6c2]" />
                <p className="mt-3 font-semibold text-[#6f5b65] text-[0.95rem]">
                  Use your mouse or stylus to sign here
                </p>
                <button
                  type="button"
                  className="mt-8 font-semibold text-[#967e88] text-[0.78rem]"
                >
                  Clear
                </button>
              </div>
              ...
              <div className="mt-5 flex flex-wrap items-center justify-between gap-4">
                <p className="flex items-center gap-2 text-[#7a656f] text-[0.84rem]">
                  <Checkbox />
          ...
          <Card className="rounded-2xl border border-primary/10 bg-primary py-0 text-primary-foreground ring-0">
            <CardContent className="grid gap-5 px-5 py-6 sm:grid-cols-[1.3fr_1fr] sm:items-center">
              <div>
                <h2 className="font-black text-[1.95rem] tracking-[-0.03em]">
                  Legal Integrity
                </h2>
                <p className="mt-3 max-w-md text-[#ffd8eb] text-[0.95rem] leading-relaxed">
                  Every signature created within ESIGN is cryptographically
                  bound to your identity, meeting eIDAS and ESIGN Act standards
                  for maximum legal enforceability.
                </p>
                <button
                  type="button"
                  className="mt-5 font-black text-[0.84rem] text-white uppercase tracking-widest"
                >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <p className="font-bold text-[#8f7b84] text-[0.62rem] uppercase tracking-[0.2em]">
              3 Saved
            </p>
          </div>
          ...
          {galleryItems.map((item) => (
            ...
            >
              <CardContent className="space-y-3 px-4 py-4">
                <Badge className="rounded-md bg-[#f7d5df] px-1.5 py-0 font-black text-[#8f5767] text-[0.52rem] uppercase tracking-[0.08em]">
                  {item.tag}
                </Badge>
